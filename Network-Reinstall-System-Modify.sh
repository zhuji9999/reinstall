...
then
	...
	echo -e "\n"
	sleep 2s
	wget --no-check-certificate -qO Core_Install.sh 'http://shell.p1e.cn/reinstall/Core_Install.sh' && bash Core_Install.sh -dd 'http://os.086.ink/centos/CentOS_7.X_NetInstallation.vhd.gz'
fi
